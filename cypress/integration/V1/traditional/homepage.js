...
describe('Traditional tests V1',() => {
    ...
    it('Task 1 - Validate the screen components on Home page - Side bar filter [type]', () => {
        const testName = 'Validate the screen components on Home page - Side bar filter [type]'
    ...
    it('Task 1 - Validate the screen components on Home page - Side bar filter [colors]', () => {
        const testName = 'Validate the screen components on Home page - Side bar filter [colors]'
    ...
    it('Task 1 - Validate the screen components on Home page - Side bar filter [brands]', () => {
        const testName = 'Validate the screen components on Home page - Side bar filter [brands]'
    ...
    it('Task 1 - Validate the screen components on Home page - Side bar filter [price]', () => {
        const testName = 'Validate the screen components on Home page - Side bar filter [price]'
    ...
    it('Validate the product grid', () => {
        const testName = 'Validate the product grid'
