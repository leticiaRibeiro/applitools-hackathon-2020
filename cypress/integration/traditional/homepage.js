...
describe('Traditional tests V1',() => {
    ...
    it('Search field should be displayed', async () => {
        cy.hackathon.shouldBeVisible(1, "Search field is displayed", 'input#INPUTtext____42')
    })

    // it('Search field should be displayed', async () => {
    //     var isDisplayed = await driver.findElement(By.id('input#INPUTtext____42')).isDisplayed()
    //     assert.assertTrue(hackathonReporter(1, "Search field is displayed", 'input#INPUTtext____42', isDisplayed));
    // }) 
